...
<form class="form-horizontal" method="POST" id="form">
	...
	<div class="form-group">
		...
		<select class="form-control" name="level">
			...
			<option value="Admin" <?php echo ($data_target['rows']['level'] == 'Admin') ? 'selected' : '' ?>>Owner</option>
			<option value="Member" <?php echo ($data_target['rows']['level'] == 'Member') ? 'selected' : '' ?>>Admin</option>
			<option value="Client" <?php echo ($data_target['rows']['level'] == 'Client') ? 'selected' : '' ?>>Reseller</option>
		</select>
	</div>
	<div class="form-group">
