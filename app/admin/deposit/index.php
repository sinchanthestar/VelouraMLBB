												...
												<tr>
													...
													<td><div class="btn-group mb-2">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item" href="lib/status.php?id=<?php echo $data_query['id'] ?>&status=Success" onclick="update_data('lib/status.php?id=<?php echo $data_query['id'] ?>&status=Success')">Success</a>
															<a class="dropdown-item" href="javascript:;" onclick="update_data('lib/status.php?id=<?php echo $data_query['id'] ?>&status=Canceled')">Canceled</a>
															<a class="dropdown-item" href="javascript:;" onclick="update_data('lib/status.php?id=<?php echo $data_query['id'] ?>&status=Pending')">Pending</a>
														</div>
													</div></td>
