...
if (isset($_GET['search']) AND isset($_GET['type'])) {
	if (!empty($_GET['search']) AND !empty($_GET['type'])) {
		$query_list = "SELECT * FROM deposit_methods WHERE name LIKE '%".protect_input($_GET['search'])."%' AND type LIKE '%".protect_input($_GET['type'])."%' ORDER BY id DESC";
	} else if (!empty($_GET['search'])) {
		$query_list = "SELECT * FROM deposit_methods WHERE name LIKE '%".protect_input($_GET['search'])."%' ORDER BY id DESC";
	} else if (!empty($_GET['type'])) {
		$query_list = "SELECT * FROM deposit_methods WHERE type LIKE '%".protect_input($_GET['type'])."%' ORDER BY id DESC";
	} else {
		$query_list = "SELECT * FROM deposit_methods ORDER BY id DESC";
	}
} else {
	$query_list = "SELECT * FROM deposit_methods ORDER BY id DESC";
}
