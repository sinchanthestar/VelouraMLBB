...
?>
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-trophy fa-fw"></i> 5 Pesanan Terbanyak</h4>
...
?>
							...
							<div class="col-lg-6">
								<div class="card-box">
									<h4 class="m-t-0 m-b-30 header-title"><i class="fa fa-trophy fa-fw"></i> 5 Deposit Terbanyak</h4>
									<div class="table-responsive">
										<table class="table">
											<tr>
												<th>PERINGKAT</th>
